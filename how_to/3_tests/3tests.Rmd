...
For a lower one-tailed test at significance level *p*<0.05, the lower bound of the zone of chance is equal to $(national\ standard\ deviation)*\sqrt{χ^2_{\ α=0.05,\ N-1}/(N-1)}$  
For $N=7$,  
$χ^2_{\ α=0.05,\ 6}=1.635$  
thus
```r
